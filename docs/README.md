...
The site appears at <http://127.0.0.1:4000/VOXL-Editor/>.

## Enabling GitHub Pages (one-time setup)

1. Go to <https://github.com/william-saxton/VOXL-Editor/settings/pages>
2. Under **Source**, choose **Deploy from a branch**
3. Set the branch to **main** and the folder to **/docs**
4. Click **Save**
5. Wait ~1 minute. The site goes live at <https://william-saxton.github.io/VOXL-Editor/>
